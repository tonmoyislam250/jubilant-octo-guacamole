...
from .ext_utils.fs_utils import start_cleanup, clean_all, exit_clean_up
from .ext_utils.telegraph.import telegraph
...
from .telegram.message_utils import sendMessage, sendMarkup, editMessage, sendLogFile, sendMedia
from .telegram.filters import CustomFilters
...
def start(update, context):
    buttons = ButtonMaker()
    buttons.buildbutton("Repo", "https://github.com/tonmoyislam250/legendary-chainsaw")
    buttons.buildbutton("Report Group", "https://t.me/+j6W32ofEDithODI1")
...
def restart(update, context):
    ...
    alive.kill()
    clean_all()
    srun(["pkill", "-9", "-f", "gunicorn|mrbeast|pewdiepie|megasdkrest|mutahar"])
